...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('inventory', InventoryController::class)
        ...
        ->middleware('permission:view_item_master');

    Route::post('/inventory/{product}/adjust', [InventoryController::class, 'adjust'])
        ->name('inventory.adjust')
        ->middleware('permission:adjust_stock_item_master');

    // ← NEW: Stock API endpoint used by Stock Adjustment UI
    ...
    Route::get('/invoices/{invoice}/print/{format?}', [InvoiceController::class, 'printInvoice'])
        ->name('invoices.print')
        ->middleware('permission:print_invoices')
    ...
    Route::get('/settings/reception', function () {
        return redirect()->route('settings.billing');
    })->name('settings.reception');
