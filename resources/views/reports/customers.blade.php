...
<div id="report-content" class="panel">
        ...
        <table class="report-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        Rs. {{ number_format(
                            $customer->jobs->sum(fn ($job) => $job->invoice?->total ?? 0),
                            2
                        ) }}
                    </td>
                </tr>
    ...
    @if($customers->total() > $paginationThreshold)
        ...
        <body>
            <div class="thermal">
                ...
                @foreach($customers as $customer)
                    @php
                        $periodJobs = $customer->jobs;
                        $totalSpent = $periodJobs->sum(
                            fn ($job) => $job->invoice?->total ?? 0
                        );
                    @endphp
                    ...
                    <div class="customer">
                        ...
                        <div class="customer-row">
                            <span>Jobs</span>
                            <span>{{ $periodJobs->count() }}</span>
                        </div>

                        <div class="customer-row">
                            <span>Total Spent</span>
                            <span class="customer-total">
