...
class CurrentContext
{
    ...
    /**
     * The tenant resolved for this request by IdentifyTenant (from the URL
     * prefix), falling back to the authenticated user's own tenant_id. The
    ...
    public function timezone(): string
    {
        ...
        return Settings::str('business.timezone', config('app.timezone'));
    }

    public function currencyCode(): string
    {
        return $this->hasTenant() ? Settings::str('business.currency_code', 'LKR') : 'LKR';
    }

    public function currencySymbol(): string
    {
        return $this->hasTenant() ? Settings::str('business.currency_symbol', 'Rs.') : 'Rs.';
    }
