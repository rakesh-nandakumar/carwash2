 ...
 * login on a real deployment, since no seeder seeds a well-known demo password.
 *
...
class CreateCentralAdmin extends Command
{
    ...
    public function handle(): int
    {
        ...
        $base = rtrim((string) config('app.url'), '/').'/'.config('tenancy.central_prefix');
        $this->components->bulletList(["Sign in at {$base}/login"]);
