...
/**
 * A SaaS customer account (one car-wash company), root of the tenant
 * isolation boundary. Deliberately carries no BelongsToTenant scope itself —
 * it IS the tenant — and is only ever created/edited from the central
 * (platform) admin, never from inside a tenant's own app.
 */
class Tenant extends Model
{
     ...
     * data is reachable from that tenant's own URL prefix rather than sitting
     * unowned.
     */
